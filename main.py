"""
Mira-style Chat Interface for Mira - Built with Textual.
...
class MiraApp(App):
    """Mira-style Chat App with LangGraph agent."""
    ...
    def compose(self) -> ComposeResult:
        ...
        with ChatScroll(id="chat-scroll"):
            ...
            if self.messages:
                ...
                yield Message(
                    "Welcome to Mira! I'm your AI coding assistant.\n\n"
                    "Commands:\n"
    ...
    def _run_init_command(self) -> None:
        """Run the /init command to generate Mira.md."""
        chat_scroll = self.query_one("#chat-scroll", ChatScroll)
        current_time = datetime.now().strftime("%I:%M %p")
        ...
        processing_msg = Message(
            "🔍 Analyzing codebase and generating Mira.md...",
            model="Mira",
            time=current_time
        )
        ...
        result_msg = Message(
            f"{result}\n\n"
            "The `Mira.md` file is now your project's AI handbook. "
